...
Путь к медиа — либо от корня сайта (`/img/shot.png`, файл из `public/`), либо
относительно markdown-файла страницы (`./media/shot.png`, файл рядом со
страницей). Подробности — в разделе [Структура и медиа](./structure).
