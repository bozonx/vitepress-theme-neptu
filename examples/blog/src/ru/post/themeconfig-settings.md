---
title: Настройки themeConfig - 2 и 3 уровень конфигурации. Навигация, сайдбар, футер, подвал поста, оглавление
description: >
  Все не системные настройки themeConfig второго и третьего уровня: верхняя
  панель, сайдбар, футер, подвал поста, кнопки «поделиться», оглавление и правая колонка.
authorId: ivan-k
date: 2026-08-04
...
схема уровней — в [Уровни конфигурации, конфиг первого уровня и шаблоны строк](config-layers).
