...
`site.yaml` (уровень 2) и `_site.yaml` (уровень 3). Системные настройки — в
[Системных настройках](system-settings), общая схема уровней — в
[Уровнях конфигурации](config-layers).
