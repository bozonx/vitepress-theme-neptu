...
карточку автора в футере, ссылается на страницу со списком постов автора, выводит
мета-теги `twitter:creator` и `article:author`, а также генерирует JSON-LD
`Person` для структурированных данных.
