...
В правой колонке находится оглавление статьи (Table of Contents), а под ним — всё, что вы туда положите: [рекламный блок](ads), и ваши кастомные блоки в слоте `aside`. Колонка появляется только на широких экранах, шириной более 1550px.

### Оглавление

Оглавление строится из заголовков страницы автоматически. По умолчанию оно включено **только в постах**.
