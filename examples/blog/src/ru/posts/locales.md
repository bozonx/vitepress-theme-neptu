...
Когда пользователь находится на `/ru/posts/hello`, дерево контента, метаданные языка
...
- `/en/posts/hello` → локаль `en`
- `/en-GB/posts/hello` → локаль `en-GB`
- `/ru/pages/about` → локаль `ru`
