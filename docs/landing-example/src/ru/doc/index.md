...
Это вся настройка. Все блоки и примитивы зарегистрированы глобально, поэтому в
markdown их можно использовать без импортов.
...
<LnCta
  bg="brand"
  title="Готовы?"
  :actions="[{ text: 'Читать документацию', link: '/doc' }]"
/>
