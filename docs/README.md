...
This is the documentation site for `vitepress-theme-neptu`, built with the
theme itself. It doubles as a live demo: every page is a working example of a
feature. Published at **https://bozonx.github.io/vitepress-theme-neptu**.
...
`--base /vitepress-theme-neptu/` because this site is deployed to a
GitHub Pages subpath (`bozonx.github.io/vitepress-theme-neptu`). The
