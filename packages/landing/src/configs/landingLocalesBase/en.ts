...
export default {
  ...
  t: {
    ...
    landing: {
      ...
      hero: { playVideo: 'Play background video', pauseVideo: 'Pause background video' },
      tabs: { region: 'Tabs' },
      compare: { region: 'Comparison', yes: 'Yes', no: 'No' },
      embed: { title: 'Embedded content' },
      timeline: { done: 'Completed', active: 'In progress', planned: 'Planned' },
    },
    ...shared,
  },
}
