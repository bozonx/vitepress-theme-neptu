...
export default {
  ...
  t: {
    ...
    landing: {
      ...
      hero: { playVideo: 'Воспроизвести фоновое видео', pauseVideo: 'Остановить фоновое видео' },
      tabs: { region: 'Вкладки' },
      compare: { region: 'Сравнение', yes: 'Да', no: 'Нет' },
      embed: { title: 'Встроенный контент' },
      timeline: { done: 'Завершено', active: 'В процессе', planned: 'Запланировано' },
    },
    ...shared,
  },
}
