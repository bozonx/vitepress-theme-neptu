...
const SearchUISchema = z.looseObject({
  noResultsText: z.string().optional(),
  resetButtonTitle: z.string().optional(),
  displayDetails: z.string().optional(),
  backButtonTitle: z.string().optional(),
  footer: z.looseObject({
    selectText: z.string().optional(),
    selectKeyAriaLabel: z.string().optional(),
    navigateText: z.string().optional(),
    navigateUpKeyAriaLabel: z.string().optional(),
    navigateDownKeyAriaLabel: z.string().optional(),
    closeText: z.string().optional(),
    closeKeyAriaLabel: z.string().optional(),
  }).optional(),
})
...
const TranslationSchema = z.looseObject({
  ...
  similarPosts: z.string().optional(),
  shareSocialMedia: z.string().optional(),
  currentLang: z.string().optional(),
  tagBadgeCount: z.string().optional(),
  tagPageHeader: z.string().optional(),
  tags: z.string().optional(),
  allTags: z.string().optional(),
  categories: z.string().optional(),
  allCategories: z.string().optional(),
  categoryPageHeader: z.string().optional(),
  categoryBadgeCount: z.string().optional(),
  allCategoriesCall: z.string().optional(),
  breadcrumbHome: z.string().optional(),
  paginationToStart: z.string().optional(),
  paginationToEnd: z.string().optional(),
  toHome: z.string().optional(),
  toBlog: z.string().optional(),
  author: z.string().optional(),
  year: z.string().optional(),
  showMorePosts: z.string().optional(),
  listenPodcast: z.string().optional(),
  commentLink: z.string().optional(),
  allTagsCall: z.string().optional(),
  viewInAnotherLanguage: z.string().optional(),
  postVideoButton: z.string().optional(),
  allPostsOfAuthor: z.string().optional(),
  closeMenu: z.string().optional(),
  allPostsOfYear: z.string().optional(),
  pageNotFound: z.string().optional(),
  postsCount: z.string().optional(),
  editLink: z.string().optional(),
  postsCountForms: z.array(z.string()).optional(),
  search: z.string().optional(),
  searchInBlog: z.string().optional(),
  searchUI: SearchUISchema.optional(),
  draftLabel: z.string().optional(),
  draftTitle: z.string().optional(),
  readingTime: z.string().optional(),
  readingTimeForms: z.array(z.string()).optional(),
  tocLabel: z.string().optional(),
  adLabel: z.string().optional(),
  links: z.record(z.string(), z.string()).optional(),
  months: z.array(z.string()).optional(),
  podcasts: z.record(z.string(), z.string()).optional(),
  audioFile: z.record(z.string(), z.string()).optional(),
  fileDownload: z.record(z.string(), z.string()).optional(),
  videoFile: z.record(z.string(), z.string()).optional(),
  lightbox: z.record(z.string(), z.string()).optional(),
})
...
const ThemeConfigSchema = z
  .looseObject({
    ...
    sidebar: z.looseObject({
      ...
      tagsCount: z.number().int().min(0).optional(),
      categoriesCount: z.number().int().min(0).optional(),
      donate: z.boolean().optional(),
