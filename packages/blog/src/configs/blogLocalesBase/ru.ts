...
export default {
  ...
  t: {
    ...
    categoryPageHeader: 'Все посты в категории',
    categoryBadgeCount: 'Количество постов в этой категории',
    allCategoriesCall: 'Все категории',
    ...
    videoFile: {
      ...
      retry: 'Повторить',
      videoPlaybackAborted: 'Воспроизведение видео было прервано',
      networkErrorLoadingVideo: 'Ошибка сети при загрузке видео',
      videoDecodingError: 'Ошибка декодирования видео',
      videoFormatNotSupported: 'Формат видео не поддерживается',
      unknownVideoError: 'Произошла неизвестная ошибка видео',
      errorLoadingVideoFile: 'Ошибка загрузки видео файла',
    },
  },
}
