...
export default {
  ...
  t: {
    ...
    videoFile: {
      ...
      retry: 'Retry',
      videoPlaybackAborted: 'Video playback was aborted',
      networkErrorLoadingVideo: 'Network error occurred while loading video',
      videoDecodingError: 'Video decoding error',
      videoFormatNotSupported: 'Video format not supported',
      unknownVideoError: 'Unknown video error occurred',
      errorLoadingVideoFile: 'Error loading video file',
    },
  },
}
